...
Web research is available through `web_search` and `web_fetch` tools
...
- If a matching skill exists, read its `SKILL.md` in it's entirety before taking action and follow it closely.
